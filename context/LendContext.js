...
export const CreateLendProvider = ({ children }) => {
  ...
  const getTrains = async () => {
    const res = await axios({
      ...
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2ODk5NDE0OTEsImNvbXBhbnlOYW1lIjoiSm95IENlbnRyYWwiLCJjbGllbnRJRCI6ImYxMjFhYzI5LWUzNzAtNDlmMi1hNDA4LTFkMDJjZGZhMWU5YiIsIm93bmVyTmFtZSI6IiIsIm93bmVyRW1haWwiOiIiLCJyb2xsTm8iOiIyMDA1MjM2In0.rAiNQQ1Fr2MfddPAT4VoVRO-_oLGINVYilPC5DeRTPc`,
      },
    });
